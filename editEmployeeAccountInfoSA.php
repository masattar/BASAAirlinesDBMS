...
if(isset($_POST['save'])){
    ...
    header("Location: accountinfo_stationattendant.php"); //redirect to Home page
    exit;
}
    ...
    <body>
        ...
        <div class ="content">
           <div class="container">
               ...
               <div class="box">
                   <br>
                   <div class="backbutton"><a href="accountinfo_stationattendant.php">Back</a></div><br>
                   ...
                   <ul>
                        <form method="POST" action="#">
                            ...
                            <li class="accProp"><p class="cusAttrLeft"> Password: </p><input ID="inputblock" type="text" name="empPass" required maxlength="50"/> <br>
